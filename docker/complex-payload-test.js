...
export let options = {
    ...
    thresholds: {
        http_req_duration: ['p(95)<1000'], // increased threshold because payload is large
...
export default function () {
    const res = http.get(`${baseUrl}/api/benchmark/complex-data-transfer/${payloadCount}`, {
        tags: {
            benchmark: 'complex-payload-sweep',
...
export const handleSummary = createSummaryHandler('complex-payload-test');
