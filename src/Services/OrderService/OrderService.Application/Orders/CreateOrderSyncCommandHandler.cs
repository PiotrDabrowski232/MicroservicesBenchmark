...
public class CreateOrderSyncCommandHandler : IRequestHandler<CreateOrderSyncCommand, Guid>
{
    ...
    private readonly IPaymentClient _paymentClient; // DODANE
    private readonly IOrderRepository _orderRepository;

    public CreateOrderSyncCommandHandler(
        IInventoryClient inventoryClient,
        IPaymentClient paymentClient, // DODANE
        IOrderRepository orderRepository)
    {
        _inventoryClient = inventoryClient;
        _paymentClient = paymentClient; // DODANE
    ...
    public async Task<Guid> Handle(CreateOrderSyncCommand request, CancellationToken cancellationToken)
    {
        ...
        var totalAmount = 99.99m; // Przykładowa kwota
        ...
        var order = new Order
        {
            ...
            Status = "Completed_Sync_REST" // Zaznaczamy, że to przeszło pełne flow REST!
        };
